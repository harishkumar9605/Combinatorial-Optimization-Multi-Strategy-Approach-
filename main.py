...
def plot_results(results, title):
    ...
    ax2.legend()
    ax2.set_yscale('log') # Use a log scale for time, as it can vary dramatically

    fig.tight_layout(rect=[0, 0.03, 1, 0.95])
    plt.show()


# --- 4. Main Execution Block (Cleaned up) ---
if __name__ == "__main__":
    # --- TSP Experiment ---
    print("========= TSP EXPERIMENT =========")
    tsp_problem = TSP('data/tsp_datasets/sample.txt')
    tsp_solvers = {
    ...
    # --- Knapsack Experiment ---
    print("\n========= KNAPSACK EXPERIMENT =========")
    knapsack_problem = KnapsackProblem('data/knapsack_datasets/sample1.json')
    knapsack_solvers = {
